...
def _patch_model_identity(base: Any) -> None:
    base.DEFAULT_MODEL = "unsloth/Qwen3.6-35B-A3B-MTP-GGUF"
    base.DEFAULT_HF_GGUF_REPO_ID = "unsloth/Qwen3.6-35B-A3B-MTP-GGUF"
    base.Q4_GGUF_MODEL_FILENAME = "Qwen3.6-35B-A3B-UD-Q4_K_M.gguf"
    base.DEFAULT_GGUF_MODEL_LABEL = "Qwen3.6-35B-A3B-MTP-UD-Q4_K_M"
    base.DEFAULT_GGUF_MODEL_FILENAME = "Qwen3.6-35B-A3B-UD-Q4_K_M.gguf"
...
class LocalOnlyApp:
    def __init__(self, base_module_name: str, wrapper_script: str, display_name: str) -> None:
        ...
        _patch_model_identity(self.base)
...
_APP = build_local_only_app(
    'AI_Agent_Qubitz_Qwen3_6_35B_A3B_MTP_UD_Q4_K_M_Embd_GeneralFast_Base',
    __file__,
    'AI Agent Qubitz Qwen 3.6 35B-A3B MTP UD Q4_K_M Embd General Fast Local-Only',
)
