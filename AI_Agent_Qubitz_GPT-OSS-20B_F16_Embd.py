...
_APP = build_local_only_app(
    'AI_Agent_Qubitz_GPT_OSS_20B_F16_Embd_GeneralFast_Base',
    __file__,
    'AI Agent Qubitz GPT OSS 20B F16 Embd General Fast Local-Only',
)
