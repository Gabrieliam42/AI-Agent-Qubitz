...
GRANITE_12G_RTX3090_NUM_CTX = 131072
...
GRANITE_12G_KV_CACHE_TYPE = "q8_0"
...
_EMBEDDED_BASE_MODULE_LABEL = 'AI_Agent_Qubitz_Granite_4_1_8B_Q8_12G_SimpleFast_Base'
        ...
        class EnhancedGUI(base.QubitzGUI):
            ...
            def __init__(self, config: Any) -> None:
                ...
                self._append_transcript(
                    "system",
                    (
                        "12 GB Granite profile active. Context is capped at 101376 on non-3090 GPUs and 131072 on RTX 3090, Max Output is capped at 8096, "
...
_APP = build_local_only_app(
    'AI_Agent_Qubitz_Granite_4_1_8B_Q8_12G_SimpleFast_Base',
    __file__,
    'AI Agent Qubitz Granite 4 1 8B Q8 12G Simple Fast Local-Only',
)
