...
_EMBEDDED_BASE_MODULE_LABEL = 'AI_Agent_Qubitz_Qwen3_5_9B_Q8_12G_SimpleFast_Base'
        ...
        class EnhancedGUI(base.QubitzGUI):
            ...
            def __init__(self, config: Any) -> None:
                ...
                self._append_transcript(
                    "system",
                    (
                        "12 GB Qwen profile active. Context is capped at 101376, Max Output is capped at 8096, "
...
_APP = build_local_only_app(
    'AI_Agent_Qubitz_Qwen3_5_9B_Q8_12G_SimpleFast_Base',
    __file__,
    'AI Agent Qubitz Qwen3 5 9B Q8 12G Simple Fast Local-Only',
)
