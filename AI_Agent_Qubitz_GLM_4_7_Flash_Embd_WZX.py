...
ROUTE_PROFILE_HUIHUI_GLM_ABLITERATED_24G = "24g_retrieval"
...
class RouteDecision:
    ...
    profile: str = ROUTE_PROFILE_HUIHUI_GLM_ABLITERATED_24G
        ...
        class EnhancedAgentRunner(base.AgentRunner):
            ...
            def _runtime_fact_block(self, prompt: str) -> str:
                ...
                lines = [
                    ...
                    f"- Route profile: {decision.profile if isinstance(decision, RouteDecision) else ROUTE_PROFILE_HUIHUI_GLM_ABLITERATED_24G}",
...
_APP = build_local_only_app(
    'AI_Agent_Qubitz_Huihui_GLM_4_7_Flash_Abliterated_Q4_K_M_Embd_GeneralFast_Base',
    __file__,
    'AI Agent Qubitz Huihui GLM 4.7 Flash Abliterated Q4_K_M Embd General Fast Local-Only',
)
