...
def _patch_model_identity(base: Any) -> None:
    base.DEFAULT_MODEL = "unsloth/Qwen3.6-35B-A3B-GGUF"
    base.DEFAULT_HF_GGUF_REPO_ID = "unsloth/Qwen3.6-35B-A3B-GGUF"
    base.Q4_GGUF_MODEL_FILENAME = "Qwen3.6-35B-A3B-UD-Q4_K_M.gguf"
    base.DEFAULT_GGUF_MODEL_LABEL = "Qwen3.6-35B-A3B-UD-Q4_K_M"
