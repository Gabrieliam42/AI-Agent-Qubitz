...
def _patch_model_identity(base: Any) -> None:
    base.DEFAULT_MODEL = "deepreinforce-ai/Ornith-1.0-35B-GGUF"
    base.DEFAULT_HF_GGUF_REPO_ID = "deepreinforce-ai/Ornith-1.0-35B-GGUF"
    base.Q4_GGUF_MODEL_FILENAME = "ornith-1.0-35b-Q4_K_M.gguf"
    base.DEFAULT_GGUF_MODEL_LABEL = "Ornith-1.0-35B-Q4_K_M"
    base.DEFAULT_GGUF_MODEL_FILENAME = "ornith-1.0-35b-Q4_K_M.gguf"
...
_APP = build_local_only_app(
    'AI_Agent_Qubitz_Ornith_1_0_35B_Q4_K_M_Embd_GeneralFast_Base',
    __file__,
    'AI Agent Qubitz Ornith 1.0 35B Q4_K_M Embd General Fast Local-Only',
)
