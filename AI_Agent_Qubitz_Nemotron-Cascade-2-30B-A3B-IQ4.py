...
ROUTE_PROFILE_NEMOTRON_CASCADE_24G = "24g_retrieval"
...
class RouteDecision:
    ...
    profile: str = ROUTE_PROFILE_NEMOTRON_CASCADE_24G
        ...
        class EnhancedAgentRunner(base.AgentRunner):
            ...
            def _runtime_fact_block(self, prompt: str) -> str:
                ...
                lines = [
                    ...
                    f"- Route profile: {decision.profile if isinstance(decision, RouteDecision) else ROUTE_PROFILE_NEMOTRON_CASCADE_24G}",
...
_APP = build_local_only_app(
    'AI_Agent_Qubitz_Nemotron_Cascade_2_30B_A3B_IQ4_GeneralFast_Base',
    __file__,
    'AI Agent Qubitz Nemotron Cascade 2 30B A3B IQ4 General Fast Local-Only',
)
