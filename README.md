...
- `AI_Agent_Qubitz_Qwen3.5_9B_Q8_12G.py` - 12GB VRAM GPU `Qwen Team's` `Qwen-3.5-9B Q8` using embedding model `BAAI/bge-code-v1`
- `AI_Agent_Qubitz_Granite-4.1-8B_Q8_12G.py` - 12GB VRAM GPU `IBM's` `Granite-4.1-8B Q8` also with `BAAI/bge-code-v1`
- `AI_Agent_Qubitz_GLM_4.7_Flash-30B-A3B-Q4.py` - 24 GB VRAM GPU `Z.AI's` `GLM-4.7-Flash 30B A3B MoE Q4` also using `BAAI/bge-code-v1`
- `AI_Agent_Qubitz_North-Mini-Code-1.0-30B-A3B-Q4.py` - 24 GB VRAM GPU `Cohere's` `North-Mini-Code-1.0 30B A3B MoE Q4` also using `BAAI/bge-code-v1`
- `AI_Agent_Qubitz_Devstral-Small-2-24B-Q4.py` - 24 GB VRAM GPU `Mistral AI's` `Devstral-Small-2 24B Q4` also with `BAAI/bge-code-v1`
- `AI_Agent_Qubitz_Gemma-4-31B-IT_QAT-Q4.py` - 24 GB VRAM GPU `Google's` `Gemma-4-31B-IT-QAT Q4` using `BAAI/bge-code-v1`
- `AI_Agent_Qubitz_GPT-OSS-20B_F16.py` - 24 GB VRAM GPU `OpenAI's` `GPT-OSS-20B F16` using `BAAI/bge-code-v1`
- `AI_Agent_Qubitz_Ornith-1.0-35B-Q4.py` - 24 GB VRAM GPU `DeepReinforce AI's` `Ornith-1.0-35B MoE Q4` using `BAAI/bge-code-v1`
- `AI_Agent_Qubitz_Qwen3.6-27B_Q4.py` - 24 GB VRAM GPU `Qwen Team's` `Qwen-3.6-27B Q4 Dense` with `BAAI/bge-code-v1`
- `AI_Agent_Qubitz_Qwen3.6-35B-A3B_MTP_Q4.py` - 24 GB VRAM GPU `Qwen Team's` `Qwen-3.6-35B-MTP A3B MoE Q4` with `BAAI/bge-code-v1`
