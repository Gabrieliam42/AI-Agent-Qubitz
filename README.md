...
- Project `.skills` directories are supported for local skill discovery and runtime skill access only when a usable `.skills` directory is present.
...
wsl .venv/bin/python AI_Agent_Qubitz_Gemma-4-31B-It_Qat_Embd.py
```
