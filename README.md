...
- `AI_Agent_Qubitz_GLM_4.7_Flash-30B-A3B-Q4.py` - 24 GB VRAM GPU `GLM 4.7 Flash 30B A3B MoE Q4` also using `BAAI/bge-code-v1`
- `AI_Agent_Qubitz_North-Mini-Code-1.0-30B-A3B-Q4.py` - 24 GB VRAM GPU `North-Mini-Code-1.0 30B A3B MoE Q4` also using `BAAI/bge-code-v1`
- `AI_Agent_Qubitz_Devstral-Small-2-24B-Q4.py` - 24 GB VRAM GPU `Devstral Small 2 24B Q4` also with `BAAI/bge-code-v1`
- `AI_Agent_Qubitz_Gemma-4-31B-IT_QAT-Q4.py` - 24 GB VRAM GPU `Gemma 4 31B IT QAT Q4` using `BAAI/bge-code-v1`
- `AI_Agent_Qubitz_GPT-OSS-20B_F16.py` - 24 GB VRAM GPU `GPT-OSS 20B F16 using `BAAI/bge-code-v1`
