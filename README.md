...
- `AI_Agent_Qubitz_Ornith-1.0-35B-Q4.py` - 24 GB VRAM GPU `Ornith-1.0-35B MoE Q4` using `BAAI/bge-code-v1`
- `AI_Agent_Qubitz_Qwen3.6-27B_Q4.py` - 24 GB VRAM GPU `Qwen 3.6 27B Q4 Dense` with `BAAI/bge-code-v1`
- `AI_Agent_Qubitz_Qwen3.6-35B-A3B_MTP_Q4.py` - 24 GB VRAM GPU `Qwen 3.6 35B A3B MoE MTP Q4` with `BAAI/bge-code-v1`
