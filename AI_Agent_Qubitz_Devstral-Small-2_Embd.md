...
Variant summary for `AI_Agent_Qubitz_Devstral-Small-2_Embd.py`.

## Purpose
- Standalone local-only Qubitz wrapper for the Devstral Small 2 24B GGUF workflow.
...
## Model and runtime
- Served model alias: `unsloth/Devstral-Small-2-24B-Instruct-2512`
- GGUF repo: `unsloth/Devstral-Small-2-24B-Instruct-2512-GGUF`
- Default GGUF label: `Unsloth-Devstral-Small-2-24B-Q4_K_M`
- Default GGUF filename: `Devstral-Small-2-24B-Instruct-2512-Q4_K_M.gguf`
...
- Uses the Devstral/Mistral-family workflow with `codesage/codesage-large-v2` retrieval

## Typical use
- Best fit when you want a higher-context embedding-enabled local workflow on the Devstral model line
