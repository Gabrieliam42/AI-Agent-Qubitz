...
AGENTIC_QWEN_12G_RTX3090_NUM_CTX = 262144
...
AGENTIC_QWEN_12G_KV_CACHE_TYPE = "q8_0"
...
_EMBEDDED_BASE_MODULE_LABEL = 'AI_Agent_Qubitz_AgenticQwen_8B_i1_Q6_12G_Base'
        ...
        class EnhancedGUI(base.QubitzGUI):
            ...
            def __init__(self, config: Any) -> None:
                ...
                self._append_transcript(
                    "system",
                    (
                        "AgenticQwen 8B Q6_K 12 GB profile active. Context is capped at 101376, Max Output is capped at 8096, "
...
_APP = build_local_only_app(
    'AI_Agent_Qubitz_AgenticQwen_8B_i1_Q6_12G_Base',
    __file__,
    'AI Agent Qubitz AgenticQwen 8B i1 Q6_K 12G Local-Only',
)
