...
ROUTE_PROFILE_NEMOTRON_24G = "24g_retrieval"
...
class RouteDecision:
    ...
    profile: str = ROUTE_PROFILE_NEMOTRON_24G
        ...
        class EnhancedAgentRunner(base.AgentRunner):
            ...
            def _runtime_fact_block(self, prompt: str) -> str:
                ...
                lines = [
                    ...
                    f"- Route profile: {decision.profile if isinstance(decision, RouteDecision) else ROUTE_PROFILE_NEMOTRON_24G}",
...
_APP = build_local_only_app(
    'AI_Agent_Qubitz_Nemotron_3_Nano_30B_A3B_IQ4_GeneralFast_Base',
    __file__,
    'AI Agent Qubitz Nemotron 3 Nano 30B A3B IQ4 General Fast Local-Only',
)
