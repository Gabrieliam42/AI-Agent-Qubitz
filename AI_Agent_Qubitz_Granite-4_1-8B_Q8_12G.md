...
Variant summary for `AI_Agent_Qubitz_Granite-4_1-8B_Q8_12G.py`.

## Purpose
- Standalone local-only Qubitz wrapper for the Granite 4.1 8B Q8 GGUF workflow.
...
## Model and runtime
- Served model alias: `unsloth/granite-4.1-8b-GGUF`
- GGUF repo: `unsloth/granite-4.1-8b-GGUF`
- Default GGUF label: `Granite-4.1-8B-Q8`
- Default GGUF filename: `granite-4.1-8b-Q8_0.gguf`
