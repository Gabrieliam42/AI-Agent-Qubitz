...
def _patch_model_identity(base: Any) -> None:
    base.DEFAULT_MODEL = "unsloth/Qwen3.6-27B-GGUF"
    base.DEFAULT_HF_GGUF_REPO_ID = "unsloth/Qwen3.6-27B-GGUF"
    base.Q4_GGUF_MODEL_FILENAME = "Qwen3.6-27B-UD-Q4_K_XL.gguf"
    base.DEFAULT_GGUF_MODEL_LABEL = "Qwen3.6-27B-UD-Q4_K_XL"
    base.DEFAULT_GGUF_MODEL_FILENAME = "Qwen3.6-27B-UD-Q4_K_XL.gguf"
...
_APP = build_local_only_app(
    'AI_Agent_Qubitz_Qwen3_6_27B_UD_Q4_K_XL_Embd_GeneralFast_Base',
    __file__,
    'AI Agent Qubitz Qwen 3.6 27B UD Q4_K_XL Embd General Fast Local-Only',
)
